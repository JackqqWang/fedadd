...
def arg_parser():
    ...
    parser.add_argument('--communication_rounds', default=20, type=int, help='number of communication rounds')
    ...
    parser.add_argument('--centralized_epochs', default=50, type=int, help='number of centralized training epochs')
